...
for (var key in months){
        monthly_income = incomeOverTime(49.60, months[key]);
        console.log("Your income for " + key + " is " + monthly_income.toString());
}
console.log(" ");
console.log("Your weekly income will be Ksh " + incomeOverTime(46.60,7));
console.log("Your yearly income will be Ksh " + incomeOverTime(46.60,365));
console.log(" ");